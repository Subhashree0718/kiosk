...
export default function App_ModifyApplication() {
  const navigate = useNavigate();

  return (
    <GovLayout breadcrumbs={['Departments', 'Electricity', 'Tracking', 'Modify Application']}>
      <div className="max-w-3xl mx-auto my-12 px-4 text-center">
        <div className="bg-white rounded-2xl shadow-xl border border-gray-100 p-12">
          <div className="w-24 h-24 bg-indigo-50 rounded-full flex items-center justify-center mx-auto mb-6">
            <span className="material-icons text-indigo-500 text-5xl">edit_document</span>
          </div>
          <h2 className="text-2xl font-bold text-gray-800 mb-4">Modify Application</h2>
