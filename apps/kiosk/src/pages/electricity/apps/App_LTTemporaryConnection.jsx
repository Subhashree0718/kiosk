...
export default function App_LTTemporaryConnection() {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    alert('LT Temporary Connection Application Submitted Successfully!');
    navigate('/electricity/new-service-connection');
  };

  return (
    <GovLayout breadcrumbs={['Departments', 'Electricity', 'New Service Connection', 'LT Temporary Connection']}>
      
    <KioskFormCard 
        title="LT Temporary Connection" 
        subtitle="Please fill out the form below to apply for a temporary LT connection."
        icon="timer"
        theme="saffron"
    >
              ...
              <div className="col-span-2">
                ...
                <div className="radio-group">
                  <label className="radio-label">
                    <input type="radio" name="earthProtection" value="yes" required onChange={handleChange} className="w-5 h-5 text-[#d35400] border-gray-300 focus:ring-[#d35400] cursor-pointer" />
                    Yes
                  </label>
                  <label className="radio-label">
                    <input type="radio" name="earthProtection" value="no" onChange={handleChange} className="w-5 h-5 text-[#d35400] border-gray-300 focus:ring-[#d35400] cursor-pointer" />
                    No
                  </label>
                </div>
              </div>
