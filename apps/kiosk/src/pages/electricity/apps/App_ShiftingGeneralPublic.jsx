...
export default function App_ShiftingGeneralPublic() {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    alert('Shifting Service (General Public) Application Submitted!');
    navigate('/electricity/shifting-of-services');
  };

  return (
    <GovLayout breadcrumbs={['Departments', 'Electricity', 'Shifting of Services', 'General Public']}>
      
    <KioskFormCard 
        title="Shifting Services - General Public" 
        subtitle="Apply for shifting of electrical utilities (General Public)."
        icon="moving"
        theme="navy"
    >
            ...
            <div className="form-grid">
              ...
              <div className="flex flex-col gap-2 relative group col-span-1 md:col-span-2">
                <label className="text-sm font-semibold text-gray-700 flex items-center justify-between">
                  <span>Undertaking Form <span className="req-star">*</span></span>
                  <a href="#" className="text-[#e67e22] hover:underline text-xs flex items-center gap-1"><span className="material-icons text-sm">download</span> Download Format</a>
                </label>
