...
export default function App_LTServiceConnection() {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    alert('LT Service Connection Application Submitted Successfully!');
    navigate('/electricity/new-service-connection');
  };

  return (
    <GovLayout breadcrumbs={['Departments', 'Electricity', 'New Service Connection', 'LT Service Connection']}>
      
    <KioskFormCard 
        title="LT Service Connection" 
        subtitle="Please fill out the form below to apply for a new LT service connection."
        icon="bolt"
        theme="blue"
    >
              ...
              <div className="col-span-2">
                ...
                <div className="radio-group">
                  <label className="radio-label">
                    <input type="radio" name="earthProtection" value="yes" required onChange={handleChange} className="w-5 h-5 text-[#1a5276] border-gray-300 focus:ring-[#1a5276] cursor-pointer" />
                    Yes
                  </label>
                  <label className="radio-label">
                    <input type="radio" name="earthProtection" value="no" onChange={handleChange} className="w-5 h-5 text-[#1a5276] border-gray-300 focus:ring-[#1a5276] cursor-pointer" />
                    No
                  </label>
                </div>
              </div>
