...
export default function App_AgricultureLT() {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    alert('Agriculture LT Application Submitted Successfully!');
    navigate('/electricity/new-service-connection');
  };

  return (
    <GovLayout breadcrumbs={['Departments', 'Electricity', 'New Service Connection', 'Agriculture LT']}>
      
    <KioskFormCard 
        title="Agriculture LT – Cottage Industries" 
        subtitle="Please fill out the form below to apply for a new agriculture LT connection."
        icon="agriculture"
        theme="green"
    >
              ...
              <div className="col-span-2">
                ...
                <div className="radio-group">
                  <label className="radio-label">
                    <input type="radio" name="earthProtection" value="yes" required onChange={handleChange} className="w-5 h-5 text-[#27ae60] border-gray-300 focus:ring-[#27ae60] cursor-pointer" />
                    Yes
                  </label>
                  <label className="radio-label">
                    <input type="radio" name="earthProtection" value="no" onChange={handleChange} className="w-5 h-5 text-[#27ae60] border-gray-300 focus:ring-[#27ae60] cursor-pointer" />
                    No
                  </label>
                </div>
              </div>
