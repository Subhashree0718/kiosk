...
const SERVICES = [
  { path: '/electricity/lt-solar-service-tracking/application-status-ack', label: 'Application Status using Acknowledgement Number', labelHi: 'पावती संख्या द्वारा आवेदन स्थिति', icon: 'receipt_long' },
  { path: '/electricity/lt-solar-service-tracking/application-status-mobile', label: 'Application Status using Mobile Number', labelHi: 'मोबाइल नंबर द्वारा आवेदन स्थिति', icon: 'phone_iphone' },
  { path: '/electricity/lt-solar-service-tracking/modify-application', label: 'Modify Application', labelHi: 'आवेदन संशोधित करें', icon: 'edit_document' },
];

export default function LTSolarServiceTracking() {
  const navigate = useNavigate();
  return (
    <GovLayout breadcrumbs={['Departments', 'Electricity', 'Solar Tracking']}>
      ...
      <div className="kiosk-gov-header">
        ...
        <div className="kiosk-gov-title-group">
          <div className="kiosk-gov-text-hi">एलटी सौर आवेदन ट्रैकिंग</div>
          <div className="kiosk-gov-text-en">LT Solar Service Tracking</div>
      ...
      <div className="kiosk-container">
        <div className="kiosk-header">
          ...
          <p style={{ fontSize: 18, color: '#666' }}>Track or modify your solar service applications</p>
        </div>
