...
const SERVICES = [
  { path: '/electricity/existing-services/tariff-change', label: 'LT - Tariff Change', labelHi: 'एलटी - टैरिफ परिवर्तन', icon: 'swap_horiz' },
  { path: '/electricity/existing-services/tariff-conversion', label: 'LT - Tariff Conversion (1D to 1E)', labelHi: 'एलटी - टैरिफ रूपांतरण', icon: 'published_with_changes' },
  { path: '/electricity/existing-services/name-transfer', label: 'LT - Name Transfer', labelHi: 'एलटी - नाम हस्तांतरण', icon: 'manage_accounts' },
  { path: '/electricity/existing-services/additional-load', label: 'LT - Additional Load', labelHi: 'एलटी - अतिरिक्त भार', icon: 'add_circle' },
  { path: '/electricity/existing-services/reduction-of-load', label: 'LT - Reduction of Load', labelHi: 'एलटी - भार में कमी', icon: 'remove_circle' },
  { path: '/electricity/existing-services/dynamic-reduction', label: 'LT - Dynamic Reduction of Load', labelHi: 'एलटी - गतिशील भार कमी', icon: 'tune' },
];

export default function ExistingServices() {
  const navigate = useNavigate();
  return (
    <GovLayout breadcrumbs={['Departments', 'Electricity', 'Existing Services']}>
      ...
      <div className="kiosk-gov-header">
        ...
        <div className="kiosk-gov-title-group">
          <div className="kiosk-gov-text-hi">विद्यमान सेवाएं</div>
          <div className="kiosk-gov-text-en">Existing Services</div>
      ...
      <div className="kiosk-container">
        <div className="kiosk-header">
          ...
          <p style={{ fontSize: 18, color: '#666' }}>Manage and modify your existing electricity service connection</p>
        </div>
